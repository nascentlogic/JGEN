 ...
 * F.Dahl, 7/20/2026
 */
public class AtlasOld implements Disposable  {
    ...
    private AtlasOld() { /* GSON */ }

    AtlasOld(Info info, Bitmap[] bitmaps) {

    }

    AtlasOld(String name, List<Bitmap> bitmaps, List<String> names, int modifiedHash) {
